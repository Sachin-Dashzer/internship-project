...
const App = () => {
    ...
    return (
        <div className="md:px-28 p-5  md:py-10 font-sans bg-gray-100 min-h-screen">
            ...
            <div className="flex justify-center">
                <input
                    ...
                    className="md:w-3/5 w-full md:p-3 p-2 px-3 md:px-5 font-medium mb-6 text-gray-700 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
            </div>

            <div>
                {filteredUsers.length > 0 ? (
                    <div className="grid gap-4 md:gap-10 md:grid-cols-2 lg:grid-cols-4  md:mt-5 md:px-5">
                        {filteredUsers.map((user) => (
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <button className="cursor-pointer md:px-4 p-2 md:mx-auto md:mt-3 mt-2 flex items-center bg-blue-500 hover:bg-blue-700 active:border active:border-blue-400 rounded-md duration-100">
                                        <span className="md:text-sm text-xs text-slate-100 font-medium">+ Add friend </span>
                                    </button>
